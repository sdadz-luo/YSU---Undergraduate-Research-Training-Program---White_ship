...
{
    .mode                = TIMER_MODE_PWM,
    /* Actual period: 0.02 seconds. Actual duty: 50%. */ .period_counts = (uint32_t) 0xf424, .duty_cycle_counts = 0x7a12, .source_div = (timer_source_div_t)5,
    .channel             = 7,
    .p_callback          = NULL,
...
dmac_instance_ctrl_t g9_transfer_dmac_rx_ctrl;
transfer_info_t g9_transfer_dmac_rx_info =
{
    .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_INCREMENTED,
    .transfer_settings_word_b.repeat_area    = TRANSFER_REPEAT_AREA_DESTINATION,
    .transfer_settings_word_b.irq            = TRANSFER_IRQ_END,
...
const dmac_extended_cfg_t g9_transfer_dmac_rx_extend =
{
    .offset              = 1,
    .src_buffer_size     = 1,
    ...
    .ipl                 = (6),
    .channel             = 2,
    .p_callback          = transfer9_dmac_rx_callback,
    .p_context           = NULL,
    .activation_source   = ELC_EVENT_SCI9_RXI,
};
const transfer_cfg_t g9_transfer_dmac_rx_cfg =
{
    .p_info              = &g9_transfer_dmac_rx_info,
    .p_extend            = &g9_transfer_dmac_rx_extend,
};
/* Instance structure to use this module. */
const transfer_instance_t g9_transfer_dmac_rx =
{
    .p_ctrl        = &g9_transfer_dmac_rx_ctrl,
    .p_cfg         = &g9_transfer_dmac_rx_cfg,
...
dmac_instance_ctrl_t g8_transfer_dmac_rx_ctrl;
transfer_info_t g8_transfer_dmac_rx_info =
{
    .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_INCREMENTED,
    .transfer_settings_word_b.repeat_area    = TRANSFER_REPEAT_AREA_DESTINATION,
    .transfer_settings_word_b.irq            = TRANSFER_IRQ_END,
...
const dmac_extended_cfg_t g8_transfer_dmac_rx_extend =
{
    .offset              = 1,
    .src_buffer_size     = 1,
    ...
    .ipl                 = (6),
    .channel             = 7,
    .p_callback          = transfer8_dmac_rx_callback,
    .p_context           = NULL,
    .activation_source   = ELC_EVENT_SCI8_RXI,
};
const transfer_cfg_t g8_transfer_dmac_rx_cfg =
{
    .p_info              = &g8_transfer_dmac_rx_info,
    .p_extend            = &g8_transfer_dmac_rx_extend,
};
/* Instance structure to use this module. */
const transfer_instance_t g8_transfer_dmac_rx =
{
    .p_ctrl        = &g8_transfer_dmac_rx_ctrl,
    .p_cfg         = &g8_transfer_dmac_rx_cfg,
    .p_api         = &g_transfer_on_dmac
};
...
dmac_instance_ctrl_t g3_transfer_dmac_rx_ctrl;
transfer_info_t g3_transfer_dmac_rx_info =
{
    .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_INCREMENTED,
    .transfer_settings_word_b.repeat_area    = TRANSFER_REPEAT_AREA_DESTINATION,
    .transfer_settings_word_b.irq            = TRANSFER_IRQ_END,
...
const dmac_extended_cfg_t g3_transfer_dmac_rx_extend =
{
    .offset              = 1,
    .src_buffer_size     = 1,
#if defined(VECTOR_NUMBER_DMAC5_INT)
    .irq                 = VECTOR_NUMBER_DMAC5_INT,
#else
    .irq                 = FSP_INVALID_VECTOR,
#endif
    .ipl                 = (8),
    .channel             = 5,
    .p_callback          = transfer3_dmac_rx_callback,
    .p_context           = NULL,
    .activation_source   = ELC_EVENT_SCI3_RXI,
};
const transfer_cfg_t g3_transfer_dmac_rx_cfg =
{
    .p_info              = &g3_transfer_dmac_rx_info,
    .p_extend            = &g3_transfer_dmac_rx_extend,
};
/* Instance structure to use this module. */
const transfer_instance_t g3_transfer_dmac_rx =
{
    .p_ctrl        = &g3_transfer_dmac_rx_ctrl,
    .p_cfg         = &g3_transfer_dmac_rx_cfg,
    .p_api         = &g_transfer_on_dmac
};
...
#if 0
const gpt_extended_pwm_cfg_t pwm_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t pwm_extend =
{
    .gtioca = { .output_enabled = true,
                .stop_level     = GPT_PIN_LEVEL_LOW
              },
...
/* Instance structure to use this module. */
const timer_instance_t pwm =
{
    .p_ctrl        = &pwm_ctrl,
    .p_cfg         = &pwm_cfg,
    .p_api         = &g_timer_on_gpt
};
gpt_instance_ctrl_t time0_ctrl;
#if 0
const gpt_extended_pwm_cfg_t time0_pwm_extend =
{
    .trough_ipl             = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t time0_extend =
{
    .gtioca = { .output_enabled = true,
                .stop_level     = GPT_PIN_LEVEL_LOW
              },
...
dmac_instance_ctrl_t g2_transfer_dmac_rx_ctrl;
transfer_info_t g2_transfer_dmac_rx_info =
{
    .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_INCREMENTED,
    .transfer_settings_word_b.repeat_area    = TRANSFER_REPEAT_AREA_DESTINATION,
    .transfer_settings_word_b.irq            = TRANSFER_IRQ_END,
...
const dmac_extended_cfg_t g2_transfer_dmac_rx_extend =
{
    .offset              = 1,
    .src_buffer_size     = 1,
    ...
    .ipl                 = (8),
    .channel             = 3,
    .p_callback          = transfer2_dmac_rx_callback,
    .p_context           = NULL,
    .activation_source   = ELC_EVENT_SCI2_RXI,
};
const transfer_cfg_t g2_transfer_dmac_rx_cfg =
{
    .p_info              = &g2_transfer_dmac_rx_info,
    .p_extend            = &g2_transfer_dmac_rx_extend,
};
/* Instance structure to use this module. */
const transfer_instance_t g2_transfer_dmac_rx =
{
    .p_ctrl        = &g2_transfer_dmac_rx_ctrl,
    .p_cfg         = &g2_transfer_dmac_rx_cfg,
    .p_api         = &g_transfer_on_dmac
};
...
{
    .scan_mask           = ADC_MASK_CHANNEL_2 | ADC_MASK_CHANNEL_4 | ADC_MASK_CHANNEL_5 |  0,
    .scan_mask_group_b   =  0,
...
dmac_instance_ctrl_t g_transfer_dmac_rx_ctrl;
transfer_info_t g_transfer_dmac_rx_info =
{
    .transfer_settings_word_b.dest_addr_mode = TRANSFER_ADDR_MODE_INCREMENTED,
    .transfer_settings_word_b.repeat_area    = TRANSFER_REPEAT_AREA_DESTINATION,
    .transfer_settings_word_b.irq            = TRANSFER_IRQ_END,
...
const dmac_extended_cfg_t g_transfer_dmac_rx_extend =
{
    .offset              = 1,
    .src_buffer_size     = 1,
    ...
    .ipl                 = (8),
    .channel             = 1,
    .p_callback          = transfer_dmac_rx_callback,
    .p_context           = NULL,
    .activation_source   = ELC_EVENT_SCI5_RXI,
};
const transfer_cfg_t g_transfer_dmac_rx_cfg =
{
    .p_info              = &g_transfer_dmac_rx_info,
    .p_extend            = &g_transfer_dmac_rx_extend,
};
/* Instance structure to use this module. */
const transfer_instance_t g_transfer_dmac_rx =
{
    .p_ctrl        = &g_transfer_dmac_rx_ctrl,
    .p_cfg         = &g_transfer_dmac_rx_cfg,
    .p_api         = &g_transfer_on_dmac
};
